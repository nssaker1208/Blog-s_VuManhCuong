...
<div class="portfolio-grid">
  ...
  <!-- Card 7: Kỹ năng Backend -->
  <figure class="portfolio-card" data-category="skills">
    <div class="card-image" style="background-image: url('https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=800');">
      <div class="card-overlay">
        <h3>⚙️ Backend</h3>
      </div>
    </div>
    <figcaption class="card-content">
      ...
      <p><strong>Frameworks:</strong> Spring Boot, Express.js</p>
      <p><strong>API:</strong> RESTful, GraphQL (learning)</p>
      <p><strong>Auth:</strong> JWT, OAuth2</p>
    </figcaption>
  </figure>

  <!-- Card 8: Dự án cá nhân -->
  <figure class="portfolio-card" data-category="experience">
    <div class="card-image" style="background-image: url('https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800');">
      <div class="card-overlay">
        <h3>🚀 Dự án</h3>
      </div>
    </div>
    <figcaption class="card-content">
      <h4>Dự án cá nhân</h4>
      <p><strong>Blog Platform:</strong> Hugo, PaperMod, Custom CSS</p>
      <p><strong>Chat System:</strong> WebSocket real-time messaging</p>
      <p><strong>API Gateway:</strong> Microservices architecture</p>
    </figcaption>
  </figure>
